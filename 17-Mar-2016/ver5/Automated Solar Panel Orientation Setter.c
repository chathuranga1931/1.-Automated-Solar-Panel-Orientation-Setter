...
__CONFIG(FOSC_HS & WDTE_OFF & PWRTE_ON & BOREN_OFF & LVP_ON & CPD_OFF & WRT_OFF & CP_OFF);
#include "def.h"
#include "setup.h"
#include "lcdv2.h"
#include "a2d.h"
	...
	while(1){				
		switch (state){
			...
			case  LCD_FORMAT1:
				...
				LCD_print_char(1,1,'M');
                LCD_print_char(1,2,'O');
                LCD_print_char(1,3,'D');
                LCD_print_char(1,4,'E');
                
                LCD_print_char(1,6,',');
                LCD_print_char(1,10,'D');                
                LCD_print_char(1,11,',');
                
                LCD_print_char(2,3,'.');
                LCD_print_char(2,5,'V');
                LCD_print_char(2,6,',');
                LCD_print_char(2,8,'.');
                LCD_print_char(2,10,'A');                
                LCD_print_char(2,11,',');
                LCD_print_char(2,14,'.');
                LCD_print_char(2,16,'W');                
                
                //selected mode
                LCD_print_char(1,5,'1');
                //angle
                LCD_print_char(1,7,'0');
                LCD_print_char(1,8,'0');
                LCD_print_char(1,9,'0');                
                //voltage
                LCD_print_char(2,1,'0');
                LCD_print_char(2,2,'0');
...
void interrupt isr(){	
	if(TMR1IF==1){	
		...
		if(msecond == 50){
			...
			if(BlinkDet) LCD_print_char(1,14,':');
			else LCD_print_char(1,14,' ');
			BlinkDet = !BlinkDet;
