	...
	; Compiler options:
	;
	; -oASPRS.cof -mASPRS.map --summary=default --output=default \
	; Automated Solar Panel Orientation Setter.p1 --chip=16F877A -P \
	; --runtime=default --opt=default -D__DEBUG=1 --debugger=pickit2 -g \
